...
import SerafallRobot.modules.sql.global_bans_sql as gban_sql
import SerafallRobot.modules.sql.users_sql as user_sql
from SerafallRobot import DEV_USERS, OWNER_ID, dispatcher
