...
import SerafallRobot.modules.sql.connection_sql as sql
from SerafallRobot import dispatcher, SUDO_USERS, DEV_USERS
from SerafallRobot.modules.helper_funcs import chat_status
