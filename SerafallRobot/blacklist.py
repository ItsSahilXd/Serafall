...
import SerafallRobot.modules.sql.blacklist_sql as sql
from SerafallRobot import dispatcher, LOGGER
...
from SerafallRobot.modules.sql.approve_sql import is_approved
